        ...
        <Card className="p-6">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-sm text-gray-600">≤ $70/ton</p>
            </div>
            <div>
              <h4 className="font-bold mb-2">Constraints</h4>
              <ul className="text-sm text-gray-600 space-y-1">
                <li>• CO₂ emissions ≤ 350kg/ton</li>
                <li>
                  • Include at least 10% Construction Demolition Material (CDM)
                  or Calcined Clay.
                </li>
              </ul>
            </div>
            <div>
              ...
              <ul className="text-sm text-gray-600 space-y-1">
                ...
                <li>● Durability Surge: Adds crack resistance (+$6/ton). </li>
                <li>
                  ● Green Blend: Promotes eco-friendly CDM or Calcined Clay
                  (+$4/ton)
                </li>
              </ul>
            </div>
